...
3. `Download HPlattice <https://www.dropbox.com/s/dzxqoe7ye1rb2kk/hplattice-1.0.tar.gz?dl=1>`_ (or visit the `GitHub Repo <https://github.com/grollins/HP_lattice>`_)
4. Install HPlattice
